...
int main() {
  ...
  while (choice != 0) {
    ...
    cout << "2.Add Medciation To A Pharmacy" << endl;
        ...
        while(choice2 != 0){
          if(choice2 == 1){
            ...
            for(int i = 0; i < pharmacySize; i++){
              p2[i].setMedications(p[i].getMedication(), p[i].getMedicationCount());
    ...
    if (choice == 2){
      ...
      if(count == 0){
        ...
        cout<<"Year: ";
        cin>>year;
        p[index].AddMedication(Medication(medName,desc,price,quantity,bar,Date(day,month,year)));
    ...
    if (choice == 3){
      ...
      if(count == 0){
        ...
        cout<<"Phone number: ";
        cin>>phoneNum;
        p[index].AddCustomer(Customer(cName,Address(email,city,phoneNum,street)));
  ...
  Prescription p1;
  [[maybe_unused]]
  Prescription p2("Panadol","Headache",1,2,"A123",1,3,2014,89,1,4,2014);
  [[maybe_unused]]
  Prescription *ptr1 = new Prescription();
  [[maybe_unused]]
  Prescription *ptr2 = new Prescription("Panadol","Headache",1,2,"A123",1,3,2014,89,1,4,2014);
  [[maybe_unused]]
  OffTheShelf o1;
  [[maybe_unused]]
  OffTheShelf o2("Panadol","Headache",1,2,"A123",1,3,2014,true,1,6,2009);
  [[maybe_unused]]
  OffTheShelf *ptr3 = new OffTheShelf();
  [[maybe_unused]]
  OffTheShelf *ptr4 = new OffTheShelf("Panadol","Headache",1,2, "A123",1,3,2014,true,1,6,2009);
  
  delete ptr1;
  delete ptr2;
  delete ptr3;
  delete ptr4;
  //When entering a string dont add space between names
  return 0;
}
